...
for PRETRAINED_MODEL in "bert-base-german-cased"; do
    echo Experiment
    echo $MODEL
...
#        for AUGMENT in all ; do
        #   for AUGMENT in Propaganda ; do
              ...
              MODEL_PATH=saved_model/${PRETRAINED_MODEL}/${LANGUAGE}/${AUGMENT}
              AUGMENT_DATASET_PATH=dataset/augmented_data/clef2023/${LANGUAGE}/chat-gpt/${AUGMENT}.tsv
  
              mkdir -p $MODEL_PATH
  
              RESULT_OUTPUT=results/${PRETRAINED_MODEL}/${LANGUAGE}/chat-gpt/${AUGMENT}
